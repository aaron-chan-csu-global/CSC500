...
print("The sum of first and second number is", num1, "+", num2, "=", int(num1) + int(num2))


# In[6]:


print("The result of first number minus the second number is", num1, "-", num2, "=", int(num1) - int(num2))
