# ------------------------------------------------
# 3/6/2025 Aaron Chan | CSC500 - Module 8 - Portfolio Milestone
# Script: csc500.module.8.portfolio.milestone.aaron.chan.py
# ------------------------------------------------
#
# Modification Log:
# - 3/6/2025 Initiated.
...
# -----------------------------------------------------------------------------
# ItemToPurchase class - - subse of Module 4 class implementation, and it is leveraged in this module alongside the newly created ShoppingCart class.
# -----------------------------------------------------------------------------
class ItemToPurchase:
  ...
  def __init__(self, item_dictionary: Dict[str, object] = {}) -> None:
    ...
    self.description: str = item_dictionary.get("item_description", "None") # 3/6/2025 additional input capture in Module 8 for item-to-add
...
# -----------------------------------------------------------------------------
# a ShoppingCart class - a Module 6 class implementation
# -----------------------------------------------------------------------------
class ShoppingCart:
  ...
  def __init__(self, cart_items: List[Any], customer_name = "none", current_date = "January 01, 2020") -> None:
    ...
    # 3/6/2025 displaying customer name and today's date
  ...
  while True:
    ...
    match user_menu_option_choice.lower():
      ...
      case 'a': # capture basic info of item to add, and leverage add_item() method to add the item onto the shopping cart
        ...
        purchase_item_description = input("Enter the item description: ") # 3/6/2025 additional input capture in Module 8 for item to add
        ...
        item_data_dict = {
          ...
          , "item_description": purchase_item_description # 3/6/2025 additional input capture in Module 8 for item to add
...
if __name__ ==  '__main__':
  ...
  print("\n")
  cust_name_input = input("Enter customer's name: ")
  current_date_input = input("Enter today's date: ")

  # instantiating ShoppingCart object based on captured information and an empty cart
  sc = ShoppingCart(
    cart_items = []
    , customer_name = cust_name_input
